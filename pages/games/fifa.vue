            ...
            <v-card-title class="text-center justify-center py-6">
                ...
                <v-list-item ten-line>
                    ...
                    <v-list-item-subtitle>
                        <p>در این بازی تیم ها حداقل از 2 نفر و حداکثر از 4 نفر میتوانند تشکیل شده باشند.</p>
                        ...
                        <p>* درصورت برابر بودن امتیاز ها، تیمی که تفاضل گل بهتری دارد بالاتر قرار میگیرد و
                             اگر تفاضل گل نیز برابر بود نتایج بازی مستقیم دو تیم منظور میشود.</p>
                    </v-list-item-subtitle>
                    </v-list-item-content>
                </v-list-item>
          </v-card>
